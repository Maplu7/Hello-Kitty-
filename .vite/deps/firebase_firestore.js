import { B as isCloudWorkstation, C as LogLevel, D as FirebaseError, I as getGlobal, J as isSafariOrWebkit, L as getModularInstance, P as getDefaultEmulatorHostnameAndPort, Q as updateEmulatorBanner, R as getUA, T as Component, W as isIndexedDBAvailable, Y as pingServer, c as _getProvider, f as _registerComponent, g as getApp, j as deepEqual, k as createMockUserToken, n as SDK_VERSION, p as _removeServiceInstance, q as isSafari, u as _isFirebaseServerApp, w as Logger, x as registerVersion } from "./index.esm--Njlfl21.js";
...
//#endregion
//#region node_modules/@firebase/firestore/dist/common-091f2944.esm.js
/**
* @license
...
var Timestamp = class Timestamp {
	...
	*/ static fromMillis(e) {
		...
		return new Timestamp(t, Math.floor((e - 1e3 * t) * N));
	}
	/**
...
var __PRIVATE_SimpleDbTransaction = class __PRIVATE_SimpleDbTransaction {
	...
	abort(e) {
		e && this.S.reject(e), this.aborted || (__PRIVATE_logDebug(k, "Aborting transaction:", e ? e.message : "Client-initiated abort"), this.aborted = !0, this.transaction.abort());
	}
	C() {
	...
	*/ async L(e) {
		return this.db || (__PRIVATE_logDebug(k, "Opening database:", this.name), this.db = await new Promise(((t, n) => {
			...
			r.onsuccess = (e) => {
				...
				__PRIVATE_logDebug(k, "Database \"" + this.name + "\" requires upgrade from version:", e.oldVersion);
	...
	async runTransaction(e, t, n, r) {
		...
		for (;;) {
			...
			try {
				...
				if (__PRIVATE_logDebug(k, "Transaction failed with error:", t.message, "Retrying:", n), this.close(), !n) return Promise.reject(t);
			}
		}
	}
	close() {
...
*/ var __PRIVATE_SimpleDbStore = class {
	...
	*/ get(e) {
		return __PRIVATE_wrapRequest(this.store.get(e)).next(((t) => (void 0 === t && (t = null), __PRIVATE_logDebug(k, "GET", this.store.name, e, t), t)));
	}
	delete(e) {
...
var __PRIVATE_IndexBackfillerScheduler = class {
	...
	re(e) {
		__PRIVATE_logDebug(q, `Scheduled in ${e}ms`), this.task = this.asyncQueue.enqueueAfterDelay("index_backfill", e, (async () => {
			this.task = null;
			try {
				__PRIVATE_logDebug(q, `Documents written: ${await this.ne.ie()}`);
			} catch (e) {
...
/** Implements the steps for backfilling indexes. */ var __PRIVATE_IndexBackfiller = class {
	...
	/** Writes index entries until the cap is reached. Returns the number of documents processed. */ se(e, t) {
		...
		return PersistencePromise.doWhile((() => !0 === i && r > 0), (() => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next(((t) => {
			if (null !== t && !n.has(t)) return __PRIVATE_logDebug(q, `Processing collection: ${t}`), this.oe(e, t, r).next(((e) => {
				r -= e, n.add(t);
			}));
			i = !1;
		})))).next((() => t - r));
	...
	*/ oe(e, t, n) {
		return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next(((r) => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next(((n) => {
			const i = n.changes;
			return this.localStore.indexManager.updateIndexEntries(e, i).next((() => this._e(r, n))).next(((n) => (__PRIVATE_logDebug(q, `Updating offset: ${n}`), this.localStore.indexManager.updateCollectionGroup(e, t, n)))).next((() => i.size));
		}))));
	}
...
*/ function __PRIVATE_decodeResourcePath(e) {
	const t = e.length;
	if (__PRIVATE_hardAssert(t >= 2, 64408, { path: e }), 2 === t) return __PRIVATE_hardAssert(e.charAt(0) === $ && "" === e.charAt(1), 56145, { path: e }), ResourcePath.emptyPath();
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var W = "remoteDocuments", Q = "owner", G = "owner", z = "mutationQueues", j = "userId", H = "mutations", J = "batchId", Z = "userMutationsIndex", X = ["userId", "batchId"];
/**
* @license
* Copyright 2022 Google LLC
*
...
* information.
*/ var Y = {}, ee = "documentMutations", te = "remoteDocumentsV14", ne = [
	"prefixPath",
	"collectionGroup",
	"readTime",
	"documentId"
], re = "documentKeyIndex", ie = [
	"prefixPath",
	"collectionGroup",
	"documentId"
], se = "collectionGroupIndex", oe = [
	"collectionGroup",
	"readTime",
	"prefixPath",
	"documentId"
], _e = "remoteDocumentGlobal", ae = "remoteDocumentGlobalKey", ue = "targets", ce = "queryTargetsIndex", le = ["canonicalId", "targetId"], he = "targetDocuments", Pe = ["targetId", "path"], Te = "documentTargetsIndex", Ie = ["path", "targetId"], Ee = "targetGlobalKey", Re = "targetGlobal", Ae = "collectionParents", Ve = ["collectionId", "parent"], de = "clientMetadata", me = "clientId", fe = "bundles", ge = "bundleId", pe = "namedQueries", ye = "name", we = "indexConfiguration", be = "indexId", Se = "collectionGroupIndex", De = "collectionGroup", Ce = "indexState", ve = ["indexId", "uid"], Fe = "sequenceNumberIndex", Me = ["uid", "sequenceNumber"], xe = "indexEntries", Oe = [
	"indexId",
	"uid",
	"arrayValue",
	"directionalValue",
	"orderedDocumentKey",
	"documentKey"
], Ne = "documentKeyIndex", Be = [
	"indexId",
	"uid",
	"orderedDocumentKey"
], Le = "documentOverlays", ke = [
	"userId",
	"collectionPath",
	"documentId"
	...
	"collectionPath",
	"largestBatchId"
], Ue = "collectionGroupOverlayIndex", $e = [
	"userId",
	"collectionGroup",
	"largestBatchId"
], We = "globals", Qe = "name", Ge = [
	...[...[...[...[
		z,
		H,
		ee,
...
var et = /* @__PURE__ */ new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);
/**
...
*   localWriteTime.
*/ var tt = "server_timestamp", nt = "__type__", rt = "__previous_value__", it = "__local_write_time__";
function __PRIVATE_isServerTimestamp(e) {
	return (e?.mapValue?.fields || {})[nt]?.stringValue === tt;
}
/**
...
/** The default database name for a project. */ var st = "(default)";
/**
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var ot = "__type__", _t = "__max__", at = { mapValue: { fields: { __type__: { stringValue: _t } } } }, ut = "__vector__", ct = "value", lt = { nullValue: "NULL_VALUE" };
...
function __PRIVATE_valueCompare(e, t) {
	...
	switch (n) {
		...
		case 10: return function __PRIVATE_compareVectors(e, t) {
			const n = e.fields || {}, r = t.fields || {}, i = n[ct]?.arrayValue, s = r[ct]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
			if (0 !== o) return o;
			return __PRIVATE_compareArrays(i, s);
		}(e.mapValue, t.mapValue);
		case 11: return function __PRIVATE_compareMaps(e, t) {
			if (e === at.mapValue && t === at.mapValue) return 0;
			if (e === at.mapValue) return 1;
			if (t === at.mapValue) return -1;
...
/** Returns true if `value` is a VetorValue. */ function __PRIVATE_isVectorValue(e) {
	return (e?.mapValue?.fields || {})[ot]?.stringValue === ut;
}
...
var ht = { mapValue: { fields: {
	[ot]: { stringValue: ut },
	[ct]: { arrayValue: {} }
} } };
/** Returns the lowest value for the given value type (inclusive). */ function __PRIVATE_valuesGetLowerBound(e) {
	return "nullValue" in e ? lt : "booleanValue" in e ? { booleanValue: !1 } : "integerValue" in e || "doubleValue" in e ? { doubleValue: NaN } : "timestampValue" in e ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "stringValue" in e ? { stringValue: "" } : "bytesValue" in e ? { bytesValue: "" } : "referenceValue" in e ? __PRIVATE_refValue(DatabaseId.empty(), DocumentKey.empty()) : "geoPointValue" in e ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "arrayValue" in e ? { arrayValue: {} } : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? ht : { mapValue: {} } : fail(35942, { value: e });
}
/** Returns the largest value for the given value type (exclusive). */ function __PRIVATE_valuesGetUpperBound(e) {
	return "nullValue" in e ? { booleanValue: !1 } : "booleanValue" in e ? { doubleValue: NaN } : "integerValue" in e || "doubleValue" in e ? { timestampValue: { seconds: Number.MIN_SAFE_INTEGER } } : "timestampValue" in e ? { stringValue: "" } : "stringValue" in e ? { bytesValue: "" } : "bytesValue" in e ? __PRIVATE_refValue(DatabaseId.empty(), DocumentKey.empty()) : "referenceValue" in e ? { geoPointValue: {
		latitude: -90,
		longitude: -180
	} } : "geoPointValue" in e ? { arrayValue: {} } : "arrayValue" in e ? ht : "mapValue" in e ? __PRIVATE_isVectorValue(e) ? { mapValue: {} } : at : fail(61959, { value: e });
}
...
var __PRIVATE_QueryImpl = class {
	...
	*/
	constructor(e, t = null, n = [], r = [], i = null, s = "F", o = null, _ = null) {
		this.path = e, this.collectionGroup = t, this.explicitOrderBy = n, this.filters = r, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = _, this.Ie = null, this.Ee = null, this.Re = null, this.startAt, this.endAt;
	}
};
...
*/ function __PRIVATE_applyTransformOperationToLocalView(e, t, n) {
	return e instanceof __PRIVATE_ServerTimestampTransform ? function serverTimestamp$1(e, t) {
		...
		return t && __PRIVATE_isServerTimestamp(t) && (t = __PRIVATE_getPreviousValue(t)), t && (n.fields[rt] = t), { mapValue: n };
...
function __PRIVATE_isPermanentError(e) {
	switch (e) {
		...
		case C.INTERNAL:
		case C.UNAVAILABLE:
		case C.UNAUTHENTICATED: return !1;
...
function __PRIVATE_mapCodeFromRpcCode(e) {
	...
	switch (e) {
		case At.OK: return C.OK;
		case At.CANCELLED: return C.CANCELLED;
		case At.UNKNOWN: return C.UNKNOWN;
		case At.DEADLINE_EXCEEDED: return C.DEADLINE_EXCEEDED;
		case At.RESOURCE_EXHAUSTED: return C.RESOURCE_EXHAUSTED;
		case At.INTERNAL: return C.INTERNAL;
		case At.UNAVAILABLE: return C.UNAVAILABLE;
		case At.UNAUTHENTICATED: return C.UNAUTHENTICATED;
		case At.INVALID_ARGUMENT: return C.INVALID_ARGUMENT;
		case At.NOT_FOUND: return C.NOT_FOUND;
		case At.ALREADY_EXISTS: return C.ALREADY_EXISTS;
		case At.PERMISSION_DENIED: return C.PERMISSION_DENIED;
		case At.FAILED_PRECONDITION: return C.FAILED_PRECONDITION;
		case At.ABORTED: return C.ABORTED;
		case At.OUT_OF_RANGE: return C.OUT_OF_RANGE;
		case At.UNIMPLEMENTED: return C.UNIMPLEMENTED;
		case At.DATA_LOSS: return C.DATA_LOSS;
...
var __PRIVATE_WatchChangeAggregator = class {
	constructor(e) {
		this.Ge = e, this.ze = /* @__PURE__ */ new Map(), this.je = __PRIVATE_mutableDocumentMap(), this.He = __PRIVATE_documentTargetMap(), this.Je = __PRIVATE_documentTargetMap(), this.Ze = new SortedMap(__PRIVATE_primitiveComparator);
	}
	/**
		...
		if (r) {
			...
			if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
				...
				if (r !== n) {
					...
					dt?.lt(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e, t, n, r, i) {
						const s = {
							localCacheCount: e,
	...
	*/
	et(e, t, n) {
		if (!this.rt(e)) return;
		const r = this.nt(e);
		this.Et(e, t) ? r.qe(t, 1) : r.Ue(t), this.Je = this.Je.insert(t, this.Rt(t).delete(e)), this.Je = this.Je.insert(t, this.Rt(t).add(e)), n && (this.je = this.je.insert(t, n));
	}
	removeTarget(e) {
		this.ze.delete(e);
	}
...
function __PRIVATE_fromWatchChange(e, t) {
	...
	if ("targetChange" in t) {
		...
		n = new __PRIVATE_WatchTargetChange(r, i, s, o && function __PRIVATE_fromRpcStatus(e) {
			return new FirestoreError(void 0 === e.code ? C.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e.code), e.message || "");
		}(o) || null);
...
var __PRIVATE_FirestoreIndexValueWriter = class {
	...
	Ct(e, t) {
		...
		} else "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.Ft(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.kt(e.mapValue, t) : (this.Kt(e.mapValue, t), this.Nt(t)) : "arrayValue" in e ? (this.qt(e.arrayValue, t), this.Nt(t)) : fail(19022, { Ut: e });
	}
	Ot(e, t) {
...
*/ var __PRIVATE_OrderedCodeWriter = class {
	...
	/** Writes utf8 bytes into this byte sequence, descending */ Xt(e) {
		for (const t of e) {
			const e = t.charCodeAt(0);
			if (e < 128) this.Ht(e);
			else if (e < 2048) this.Ht(960 | e >>> 6), this.Ht(128 | 63 & e);
			else if (t < "\ud800" || "\udbff" < t) this.Ht(480 | e >>> 12), this.Ht(128 | 63 & e >>> 6), this.Ht(128 | 63 & e);
			else {
				const e = t.codePointAt(0);
				this.Ht(240 | e >>> 18), this.Ht(128 | 63 & e >>> 12), this.Ht(128 | 63 & e >>> 6), this.Ht(128 | 63 & e);
			}
		}
		this.Jt();
	}
	...
	*/ en(e) {
	...
	/** Writes a single byte descending to the buffer.  */ Ht(e) {
		const t = 255 & e;
...
/** Represents an index entry saved by the SDK in persisted storage. */ var __PRIVATE_IndexEntry = class __PRIVATE_IndexEntry {
	...
	*/ En() {
		...
		return n.set(this.In, 0), t !== e ? n.set([0], this.In.length) : ++n[n.length - 1], new __PRIVATE_IndexEntry(this.hn, this.Pn, this.Tn, n);
	}
	Rn(e, t, n) {
		return {
			indexId: this.hn,
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var wt = "IndexedDbIndexManager", bt = new Uint8Array(0);
/**
...
var __PRIVATE_IndexedDbIndexManager = class {
		...
		return PersistencePromise.forEach(this.vn(t), ((t) => this.Fn(e, t).next(((e) => {
			...
			if (r) {
				...
				return PersistencePromise.forEach(i, ((i, s) => {
					__PRIVATE_logDebug(wt, `Using index ${function __PRIVATE_fieldIndexToString(e) {
	...
	*/ On(e, t, n, r, i, s, o) {
		...
		for (let c = 0; c < _; ++c) {
			const _ = t ? this.Nn(t[c / a]) : bt, l = this.Bn(e, _, n[c % a], r), h = this.Ln(e, _, i[c % a], s), P = o.map(((t) => this.Bn(e, _, t, !0)));
	...
	*/ xn(e, t, n) {
		...
		for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
			const e = n[i++];
			for (const n of r) if (this.qn(t, s.fieldPath) && isArray(e)) r = this.Un(r, s, e);
			else {
				const t = n.ln(s.kind);
	...
	*/ Un(e, t, n) {
	...
	getFieldIndexes(e, t) {
		...
		return (t ? n.H(Se, IDBKeyRange.bound(t, t)) : n.H()).next(((e) => {
			const t = [];
	...
	updateCollectionGroup(e, t, n) {
		...
		return this.Wn(e).next(((e) => r.H(Se, IDBKeyRange.bound(t, t)).next(((t) => PersistencePromise.forEach(t, ((t) => i.put(__PRIVATE_toDbIndexState(t.indexId, this.uid, e, n))))))));
	}
	updateIndexEntries(e, t) {
		const n = /* @__PURE__ */ new Map();
	...
	Qn(e, t, n) {
		...
		return r.ee({
			...
			range: IDBKeyRange.only([
				n.indexId,
				this.uid,
				__PRIVATE_encodeKeySafeBytes(this.Kn(n, t))
			])
		}, ((e, r) => {
	...
	*/ createRange(e, t, n) {
		...
		for (const i of n) {
			...
			if (0 === n) r[0] = e.En();
			else if (n > 0 && s < 0) r.push(i), r.push(i.En());
			else if (s > 0) break;
		}
		r.push(t);
		const i = [];
		for (let e = 0; e < r.length; e += 2) {
			if (this.Jn(r[e], r[e + 1])) return [];
			const t = r[e].An(this.uid, bt, DocumentKey.empty()), n = r[e + 1].An(this.uid, bt, DocumentKey.empty());
...
var __PRIVATE_IndexedDbMutationQueue = class __PRIVATE_IndexedDbMutationQueue {
	...
	addMutationBatch(e, t, n, r) {
		...
		return s.add({}).next(((o) => {
			...
			for (const e of r) {
				...
				c = c.add(e.key.path.popLast()), u.push(s.put(a)), u.push(i.put(t, Y));
			}
			return c.forEach(((t) => {
	...
	*/
	...
	getAllMutationBatches(e) {
		...
		return __PRIVATE_mutationsStore(e).H(Z, t).next(((e) => e.map(((e) => __PRIVATE_fromDbMutationBatch(this.serializer, e)))));
	}
...
*/ var __PRIVATE_IndexedDbTargetCache = class {
	...
	*/ forEachTarget(e, t) {
	...
	ur(e) {
		return __PRIVATE_globalTargetStore(e).get(Ee).next(((e) => (__PRIVATE_hardAssert(null !== e, 2888), e)));
	}
	cr(e, t) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var Ct = "LruGarbageCollector", vt = 1048576;
...
*/ var __PRIVATE_LruGarbageCollectorImpl = class {
	...
	nthSequenceNumber(e, t) {
		...
		return this.Vr.forEachTarget(e, ((e) => n.Er(e.sequenceNumber))).next((() => this.Vr.mr(e, ((e) => n.Er(e))))).next((() => n.maxValue));
	}
	removeTargets(e, t, n) {
...
/** Provides LRU functionality for IndexedDB persistence. */ var __PRIVATE_IndexedDbLruDelegateImpl = class {
	...
	*/ yr(e, t) {
		...
		return n.ee({ index: Te }, (([e, n], { path: s, sequenceNumber: o }) => {
...
*/ var __PRIVATE_IndexedDbRemoteDocumentCacheImpl = class {
	...
	*/ vr(e, t) {
	...
	getDocumentsMatchingQuery(e, t, n, r, i) {
		...
		return __PRIVATE_remoteDocumentsStore(e).H(IDBKeyRange.bound(o, _, !0)).next(((e) => {
			i?.incrementDocumentReadCount(e.length);
			let n = __PRIVATE_mutableDocumentMap();
			for (const i of e) {
				const e = this.Sr(DocumentKey.fromSegments(i.prefixPath.concat(i.collectionGroup, i.documentId)), i);
	...
	getAllFromCollectionGroup(e, t, n, r) {
		...
		return __PRIVATE_remoteDocumentsStore(e).ee({
			...
			const s = this.Sr(DocumentKey.fromSegments(t.prefixPath.concat(t.collectionGroup, t.documentId)), t);
	...
	getMetadata(e) {
		return __PRIVATE_documentGlobalStore(e).get(ae).next(((e) => (__PRIVATE_hardAssert(!!e, 20021), e)));
	}
	br(e, t) {
...
*/ var __PRIVATE_ReferenceSet = class {
	constructor() {
		this.kr = new SortedSet(__PRIVATE_DocReference.Kr), this.qr = new SortedSet(__PRIVATE_DocReference.Ur);
	}
...
*/ var __PRIVATE_MemoryMutationQueue = class {
	constructor(e, t) {
		this.indexManager = e, this.referenceDelegate = t, this.mutationQueue = [], this.Yn = 1, this.Jr = new SortedSet(__PRIVATE_DocReference.Kr);
	}
	checkEmpty(e) {
	...
	addMutationBatch(e, t, n, r) {
		...
		for (const t of r) this.Jr = this.Jr.add(new __PRIVATE_DocReference(t.key, i)), this.indexManager.addToCollectionParentIndex(e, t.key.path.popLast());
...
var __PRIVATE_MemoryPersistence = class {
	...
	*/
	...
	runTransaction(e, t, n) {
		...
		return this.referenceDelegate.Ti(), n(r).next(((e) => this.referenceDelegate.Ii(r).next((() => e)))).toPromise().then(((e) => (r.raiseOnCommittedEvent(), e)));
	}
	Ei(e, t) {
...
/** Performs database creation and schema upgrades. */ var __PRIVATE_SchemaConverter = class {
	...
	*/ k(e, t, n, r) {
		...
		n < 1 && r >= 1 && (function __PRIVATE_createPrimaryClientStore(e) {
			...
			e.createObjectStore(z, { keyPath: j });
			e.createObjectStore(H, {
				keyPath: J,
				autoIncrement: !0
			}).createIndex(Z, X, { unique: !0 }), e.createObjectStore(ee);
		...
		return n < 3 && r >= 3 && (0 !== n && (function __PRIVATE_dropQueryCache(e) {
			...
			(function __PRIVATE_createBundlesStore(e) {
				e.createObjectStore(fe, { keyPath: ge });
			...
			(function __PRIVATE_createDocumentOverlayStore(e) {
				const t = e.createObjectStore(Le, { keyPath: ke });
				t.createIndex(Ke, qe, { unique: !1 }), t.createIndex(Ue, $e, { unique: !1 });
			})(e);
		}))), n < 13 && r >= 13 && (s = s.next((() => function __PRIVATE_createRemoteDocumentCache(e) {
			const t = e.createObjectStore(te, { keyPath: ne });
			t.createIndex(re, ie), t.createIndex(se, oe);
		}(e))).next((() => this.Si(e, i))).next((() => e.deleteObjectStore(W)))), n < 14 && r >= 14 && (s = s.next((() => this.Di(e, i)))), n < 15 && r >= 15 && (s = s.next((() => function __PRIVATE_createFieldIndex(e) {
			e.createObjectStore(we, {
				keyPath: be,
				autoIncrement: !0
			}).createIndex(Se, De, { unique: !1 });
			e.createObjectStore(Ce, { keyPath: ve }).createIndex(Fe, Me, { unique: !1 });
			e.createObjectStore(xe, { keyPath: Oe }).createIndex(Ne, Be, { unique: !1 });
			...
			(function __PRIVATE_createGlobalsStore(e) {
				e.createObjectStore(We, { keyPath: Qe });
			})(e);
	...
	gi(e) {
		...
		return t.H().next(((t) => PersistencePromise.forEach(t, ((t) => {
			...
			return n.H(Z, r).next(((n) => PersistencePromise.forEach(n, ((n) => {
	...
	*/ yi(e) {
		...
		return e.store(Re).get(Ee).next(((e) => {
			const r = [];
			return n.ee(((n, i) => {
	...
	wi(e, t) {
		e.createObjectStore(Ae, { keyPath: Ve });
		...
		return t.store(W).ee({ Y: !0 }, ((e, t) => {
			return addEntry(new ResourcePath(e).popLast());
		})).next((() => t.store(ee).ee({ Y: !0 }, (([e, t, n], r) => {
...
function __PRIVATE_createQueryCache(e) {
	e.createObjectStore(he, { keyPath: Pe }).createIndex(Te, Ie, { unique: !0 });
	e.createObjectStore(ue, { keyPath: "targetId" }).createIndex(ce, le, { unique: !0 }), e.createObjectStore(Re);
}
var Ft = "IndexedDbPersistence", Mt = 18e5, xt = 5e3, Ot = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Nt = "main";
/**
...
var __PRIVATE_IndexedDbPersistence = class __PRIVATE_IndexedDbPersistence {
	constructor(e, t, n, r, i, s, o, _, a, u, c = 18) {
		if (this.allowTabSynchronization = e, this.persistenceKey = t, this.clientId = n, this.Ci = i, this.window = s, this.document = o, this.Fi = a, this.Mi = u, this.xi = c, this.ai = null, this.ui = !1, this.isPrimary = !1, this.networkEnabled = !0, this.Oi = null, this.inForeground = !1, this.Ni = null, this.Bi = null, this.Li = Number.NEGATIVE_INFINITY, this.ki = (e) => Promise.resolve(), !__PRIVATE_IndexedDbPersistence.v()) throw new FirestoreError(C.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
		this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.Ki = t + Nt, this.serializer = new __PRIVATE_LocalSerializer(_), this.qi = new __PRIVATE_SimpleDb(this.Ki, this.xi, new __PRIVATE_SchemaConverter(this.serializer)), this.ci = new __PRIVATE_IndexedDbGlobalsCache(), this.li = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.Pi = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.Ui = this.window.localStorage : (this.Ui = null, !1 === u && __PRIVATE_logError(Ft, "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
	}
	/**
	...
	*/ start() {
		return this.$i().then((() => {
			if (!this.isPrimary && !this.allowTabSynchronization) throw new FirestoreError(C.FAILED_PRECONDITION, Ot);
	...
	*/ $i() {
		return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", ((e) => __PRIVATE_clientMetadataStore(e).put({
			...
			if (__PRIVATE_isIndexedDbTransactionError(e)) return __PRIVATE_logDebug(Ft, "Failed to extend owner lease: ", e), this.isPrimary;
			if (!this.allowTabSynchronization) throw e;
			return __PRIVATE_logDebug(Ft, "Releasing owner lease after error during lease refresh", e), !1;
		})).then(((e) => {
			this.isPrimary !== e && this.Ci.enqueueRetryable((() => this.ki(e))), this.isPrimary = e;
		}));
	}
	ji(e) {
		return __PRIVATE_primaryClientStore(e).get(G).next(((e) => PersistencePromise.resolve(this.Xi(e))));
	}
	Yi(e) {
	...
	*/ async es() {
		if (this.isPrimary && !this.ts(this.Li, Mt)) {
			...
			const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", ((e) => {
				...
				return t.H().next(((e) => {
					const n = this.ns(e, Mt), r = e.filter(((e) => -1 === n.indexOf(e)));
	...
	*/ Hi(e) {
		...
		return __PRIVATE_primaryClientStore(e).get(G).next(((t) => {
			if (null !== t && this.ts(t.leaseTimestampMs, xt) && !this.ss(t.ownerId)) {
				...
				if (!this.Xi(t)) {
					if (!t.allowTabSynchronization) throw new FirestoreError(C.FAILED_PRECONDITION, Ot);
					return !1;
				}
			}
			return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).H().next(((e) => void 0 === this.ns(e, xt).find(((e) => {
		...
		})).next(((e) => (this.isPrimary !== e && __PRIVATE_logDebug(Ft, `Client ${e ? "is" : "is not"} eligible for a primary lease.`), e)));
	}
	async shutdown() {
		this.ui = !1, this._s(), this.Bi && (this.Bi.cancel(), this.Bi = null), this.us(), this.cs(), await this.qi.runTransaction("shutdown", "readwrite", [Q, de], ((e) => {
			const t = new __PRIVATE_IndexedDbTransaction(e, __PRIVATE_ListenSequence.ce);
			return this.Ji(t).next((() => this.Yi(t)));
		})), this.qi.close(), this.ls();
	}
	/**
	...
	* PORTING NOTE: This is only used for Web multi-tab.
	*/ hs() {
		return this.runTransaction("getActiveClients", "readonly", ((e) => __PRIVATE_clientMetadataStore(e).H().next(((e) => this.ns(e, Mt).map(((e) => e.clientId))))));
	}
	get started() {
		return this.ui;
	}
	...
	runTransaction(e, t, n) {
		...
		let s;
		return this.qi.runTransaction(e, r, i, ((r) => (s = new __PRIVATE_IndexedDbTransaction(r, this.ai ? this.ai.next() : __PRIVATE_ListenSequence.ce), "readwrite-primary" === t ? this.ji(s).next(((e) => !!e || this.Hi(s))).next(((t) => {
			if (!t) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = !1, this.Ci.enqueueRetryable((() => this.ki(!1))), new FirestoreError(C.FAILED_PRECONDITION, L);
			return n(s);
	...
	*/
	Ps(e) {
		return __PRIVATE_primaryClientStore(e).get(G).next(((e) => {
			if (null !== e && this.ts(e.leaseTimestampMs, xt) && !this.ss(e.ownerId) && !this.Xi(e) && !(this.Mi || this.allowTabSynchronization && e.allowTabSynchronization)) throw new FirestoreError(C.FAILED_PRECONDITION, Ot);
		}));
	}
	/**
	...
	*/ Zi(e) {
	...
	/** Checks the primary lease and removes it if we are the current primary. */ Ji(e) {
		...
		return t.get(G).next(((e) => this.Xi(e) ? (__PRIVATE_logDebug(Ft, "Releasing primary lease."), t.delete(G)) : PersistencePromise.resolve()));
	}
	...
	*/ ss(e) {
		try {
			...
			return __PRIVATE_logError(Ft, "Failed to get zombied client id.", e), !1;
		}
	}
	/**
...
var __PRIVATE_QueryEngine = class {
	...
	*/ gs(e, t) {
		...
		return this.indexManager.getIndexType(e, n).next(((r) => 0 === r ? null : (null !== t.limit && 1 === r && (t = __PRIVATE_queryWithLimit(t, null, "F"), n = __PRIVATE_queryToTarget(t)), this.indexManager.getDocumentsMatchingTarget(e, n).next(((r) => {
			...
			return this.fs.getDocuments(e, i).next(((r) => this.indexManager.getMinOffset(e, n).next(((n) => {
				const s = this.bs(t, r);
				return this.Ss(t, s, i, n.readTime) ? this.gs(e, __PRIVATE_queryWithLimit(t, null, "F")) : this.Ds(e, s, t, n);
			}))));
		})))));
	}
	/**
	...
	*/ ps(e, t, n, r) {
		return __PRIVATE_queryMatchesAllDocuments(t) || r.isEqual(SnapshotVersion.min()) ? PersistencePromise.resolve(null) : this.fs.getDocuments(e, n).next(((i) => {
			const s = this.bs(t, i);
			return this.Ss(t, s, n, r) ? PersistencePromise.resolve(null) : (__PRIVATE_getLogLevel() <= LogLevel.DEBUG && __PRIVATE_logDebug("QueryEngine", "Re-using previous result from %s to execute query: %s", r.toString(), __PRIVATE_stringifyQuery(t)), this.Ds(e, s, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, B)).next(((e) => e)));
		}));
	}
	...
	return n.persistence.runTransaction("Apply remote event", "readwrite-primary", ((e) => {
		...
		t.targetChanges.forEach(((s, _) => {
			...
			null !== t.targetMismatches.get(_) ? u = u.withResumeToken(ByteString.EMPTY_BYTE_STRING, SnapshotVersion.min()).withLastLimboFreeSnapshotVersion(SnapshotVersion.min()) : s.resumeToken.approximateByteSize() > 0 && (u = u.withResumeToken(s.resumeToken, r)), i = i.insert(_, u), function __PRIVATE_shouldPersistTargetData(e, t, n) {
				...
				if (t.snapshotVersion.toMicroseconds() - e.snapshotVersion.toMicroseconds() >= Lt) return !0;
...
function __PRIVATE_localStoreGetNextMutationBatch(e, t) {
	const n = __PRIVATE_debugCast(e);
	return n.persistence.runTransaction("Get next mutation batch", "readonly", ((e) => (void 0 === t && (t = U), n.mutationQueue.getNextMutationBatchAfterBatchId(e, t))));
}
/**
...
function __PRIVATE_localStoreGetNewDocumentChanges(e, t) {
	...
	return n.persistence.runTransaction("Get new document changes", "readonly", ((e) => n.xs.getAllFromCollectionGroup(e, t, __PRIVATE_newIndexOffsetSuccessorFromReadTime(r, B), Number.MAX_SAFE_INTEGER))).then(((e) => (__PRIVATE_setMaxReadTime(n, t, e), e)));
}
...
var __PRIVATE_MutationMetadata = class __PRIVATE_MutationMetadata {
	...
	*/ static $s(e, t, n) {
		...
		return s && r.error && (s = "string" == typeof r.error.message && "string" == typeof r.error.code, s && (i = new FirestoreError(r.error.code, r.error.message))), s ? new __PRIVATE_MutationMetadata(e, t, r.state, i) : (__PRIVATE_logError(Ut$1, `Failed to parse mutation state for ID '${t}': ${n}`), null);
	}
	Ws() {
		const e = {
			state: this.state,
...
var __PRIVATE_QueryTargetMetadata = class __PRIVATE_QueryTargetMetadata {
	...
	*/ static $s(e, t) {
		...
		return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (r = new FirestoreError(n.error.code, n.error.message))), i ? new __PRIVATE_QueryTargetMetadata(e, n.state, r) : (__PRIVATE_logError(Ut$1, `Failed to parse target state for ID '${e}': ${t}`), null);
	}
	Ws() {
		const e = {
			state: this.state,
...
*/ var __PRIVATE_RemoteClientState = class __PRIVATE_RemoteClientState {
	...
	*/ static $s(e, t) {
		...
		return r ? new __PRIVATE_RemoteClientState(e, i) : (__PRIVATE_logError(Ut$1, `Failed to parse client data for instance '${e}': ${t}`), null);
	}
};
/**
...
*/ var __PRIVATE_SharedOnlineState = class __PRIVATE_SharedOnlineState {
	...
	*/ static $s(e) {
		...
		return "object" == typeof t && -1 !== [
			...
			"Online",
			"Offline"
		].indexOf(t.onlineState) && "string" == typeof t.clientId ? new __PRIVATE_SharedOnlineState(t.clientId, t.onlineState) : (__PRIVATE_logError(Ut$1, `Failed to parse online state: ${e}`), null);
	}
};
/**
...
*/ var __PRIVATE_WebStorageSharedClientState = class {
	constructor(e, t, n, r, i) {
		this.window = e, this.Ci = t, this.persistenceKey = n, this.zs = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.js = this.Hs.bind(this), this.Js = new SortedMap(__PRIVATE_primitiveComparator), this.started = !1, this.Zs = [];
		const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
		...
		}(this.persistenceKey), this.Js = this.Js.insert(this.zs, new __PRIVATE_LocalClientState()), this.eo = new RegExp(`^${kt}_${s}_([^_]*)$`), this.no = new RegExp(`^${Kt$1}_${s}_(\\d+)(?:_(.*))?$`), this.ro = new RegExp(`^${qt}_${s}_(\\d+)$`), this.io = function createWebStorageOnlineStateKey(e) {
	...
	getItem(e) {
		...
		return __PRIVATE_logDebug(Ut$1, "READ", e, t), t;
	}
	setItem(e, t) {
		__PRIVATE_logDebug(Ut$1, "SET", e, t), this.storage.setItem(e, t);
	}
	removeItem(e) {
		__PRIVATE_logDebug(Ut$1, "REMOVE", e), this.storage.removeItem(e);
	}
	Hs(e) {
		const t = e;
		if (t.storageArea === this.storage) {
			if (__PRIVATE_logDebug(Ut$1, "EVENT", t.key, t.newValue), t.key === this.Xs) return void __PRIVATE_logError("Received WebStorage notification for local change. Another client might have garbage-collected our state");
			this.Ci.enqueueRetryable((async () => {
				if (this.started) {
					if (null !== t.key) {
						if (this.eo.test(t.key)) {
							if (null == t.newValue) {
								const e = this.Eo(t.key);
							...
							const e = function __PRIVATE_fromWebStorageSequenceNumber(e) {
								...
								if (null != e) try {
									...
									__PRIVATE_logError(Ut$1, "Failed to read sequence number from WebStorage", e);
								}
								return t;
							}(t.newValue);
	...
	*/ _o(e) {
	...
	async mo(e) {
		...
		__PRIVATE_logDebug(Ut$1, `Ignoring mutation for non-active user ${e.user.uid}`);
	}
	po(e) {
...
var __PRIVATE_RestConnection = class {
	...
	Wo(e, t, n, r, i) {
		...
		return this.zo(e, o, _, n, c).then(((t) => (__PRIVATE_logDebug(Qt, `Received RPC '${e}' ${s}: `, t), t)), ((t) => {
			throw __PRIVATE_logWarn(Qt, `RPC '${e}' ${s} failed with error: `, t, "url: ", o, "request:", n), t;
		}));
	}
	jo(e, t, n, r, i, s) {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var zt$1 = "WebChannelConnection", __PRIVATE_unguardedEventListen = (e, t, n) => {
	e.listen(t, ((e) => {
		try {
			n(e);
		} catch (e) {
...
var __PRIVATE_WebChannelConnection = class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection {
	...
	*/ static u_() {
		if (!__PRIVATE_WebChannelConnection.c_) __PRIVATE_unguardedEventListen(getStatEventTarget(), Event.STAT_EVENT, ((e) => {
			e.stat === Stat.PROXY ? __PRIVATE_logDebug(zt$1, "STAT_EVENT: detected buffering proxy") : e.stat === Stat.NOPROXY && __PRIVATE_logDebug(zt$1, "STAT_EVENT: detected no buffering proxy");
				...
				try {
					switch (_.getLastErrorCode()) {
						case ErrorCode.NO_ERROR:
							...
							__PRIVATE_logDebug(zt$1, `XHR for RPC '${e}' ${s} received:`, JSON.stringify(t)), i(t);
							break;
						case ErrorCode.TIMEOUT:
							__PRIVATE_logDebug(zt$1, `RPC '${e}' ${s} timed out`), o(new FirestoreError(C.DEADLINE_EXCEEDED, "Request time out"));
							break;
						case ErrorCode.HTTP_ERROR:
							const n = _.getStatus();
							if (__PRIVATE_logDebug(zt$1, `RPC '${e}' ${s} failed with status:`, n, "response text:", _.getResponseText()), n > 0) {
					...
					__PRIVATE_logDebug(zt$1, `RPC '${e}' ${s} completed.`);
				}
			}));
			const a = JSON.stringify(r);
			__PRIVATE_logDebug(zt$1, `RPC '${e}' ${s} sending request:`, r), _.send(t, "POST", a, n, 15);
		}));
	}
	T_(e, t, n) {
		...
		const a = i.join("");
		__PRIVATE_logDebug(zt$1, `Creating RPC '${e}' stream ${r}: ${a}`, o);
		const u = s.createWebChannel(a, o);
		this.I_(u);
		let c = !1, l = !1;
		const h = new __PRIVATE_StreamBridge({
			Ho: (t) => {
				l ? __PRIVATE_logDebug(zt$1, `Not sending because RPC '${e}' stream ${r} is closed:`, t) : (c || (__PRIVATE_logDebug(zt$1, `Opening RPC '${e}' stream ${r} transport.`), u.open(), c = !0), __PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} sending:`, t), u.send(t));
			},
			Jo: () => u.close()
		});
		return __PRIVATE_unguardedEventListen(u, WebChannel.EventType.OPEN, (() => {
			l || (__PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} transport opened.`), h.i_());
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.CLOSE, (() => {
			l || (l = !0, __PRIVATE_logDebug(zt$1, `RPC '${e}' stream ${r} transport closed`), h.o_(), this.E_(u));
		})), __PRIVATE_unguardedEventListen(u, WebChannel.EventType.ERROR, ((t) => {
			l || (l = !0, __PRIVATE_logWarn(zt$1, `RPC '${e}' stream ${r} transport errored. Name:`, t.name, "Message:", t.message), h.o_(new FirestoreError(C.UNAVAILABLE, "The operation could not be completed")));
...
var __PRIVATE_PersistentStream = class {
	constructor(e, t, n, r, i, s, o, _) {
		this.Ci = e, this.b_ = n, this.S_ = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, this.D_ = 0, this.C_ = null, this.v_ = null, this.stream = null, this.F_ = 0, this.M_ = new __PRIVATE_ExponentialBackoff(e, t);
	}
	/**
	...
	*/ W_() {}
	...
	G_(e, t) {
		...
		this.stream = this.j_(e, t), this.stream.Zo((() => {
			...
			n((() => 1 == ++this.F_ ? this.H_(e) : this.onNext(e)));
		}));
	}
	N_() {
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var Ht$1 = "RemoteStore";
var __PRIVATE_RemoteStoreImpl = class {
	constructor(e, t, n, r, i) {
		this.localStore = e, this.datastore = t, this.asyncQueue = n, this.remoteSyncer = {}, this.Ta = [], this.Ia = /* @__PURE__ */ new Map(), this.Ea = /* @__PURE__ */ new Set(), this.Ra = [], this.Aa = i, this.Aa.Mo(((e) => {
			n.enqueueAndForget((async () => {
				__PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Ht$1, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e) {
					const t = __PRIVATE_debugCast(e);
					t.Ea.add(4), await __PRIVATE_disableNetworkInternal(t), t.Va.set("Unknown"), t.Ea.delete(4), await __PRIVATE_enableNetworkInternal(t);
				}(this));
			}));
...
*/ function __PRIVATE_remoteStoreUnlisten(e, t) {
	...
	n.Ia.delete(t), r.O_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.Ia.size && (r.O_() ? r.L_() : __PRIVATE_canUseNetwork(n) && n.Va.set("Unknown"));
}
/**
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
	if (e.Va.set("Online"), t instanceof __PRIVATE_WatchTargetChange && 2 === t.state && t.cause) try {
		...
		await async function __PRIVATE_handleTargetError(e, t) {
			const n = t.cause;
			for (const r of t.targetIds) e.Ia.has(r) && (await e.remoteSyncer.rejectListen(r, n), e.Ia.delete(r), e.da.removeTarget(r));
		}(e, t);
	} catch (n) {
		__PRIVATE_logDebug(Ht$1, "Failed to remove targets %s: %s ", t.targetIds.join(","), n), await __PRIVATE_disableNetworkUntilRecovery(e, n);
	}
		...
		n.compareTo(t) >= 0 && await function __PRIVATE_raiseWatchSnapshot(e, t) {
			...
			return n.targetChanges.forEach(((n, r) => {
				...
				const r = e.Ia.get(t);
				if (!r) return;
				e.Ia.set(t, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), __PRIVATE_sendUnwatchRequest(e, t);
...
*/ async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
	...
	e.Ea.add(1), await __PRIVATE_disableNetworkInternal(e), e.Va.set("Offline"), n || (n = () => __PRIVATE_localStoreGetLastRemoteSnapshotVersion(e.localStore)), e.asyncQueue.enqueueRetryable((async () => {
		__PRIVATE_logDebug(Ht$1, "Retrying IndexedDB access"), await n(), e.Ea.delete(1), await __PRIVATE_enableNetworkInternal(e);
	}));
}
/**
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
	...
	n.Ea.add(3), await __PRIVATE_disableNetworkInternal(n), r && n.Va.set("Unknown"), await n.remoteSyncer.handleCredentialChange(t), n.Ea.delete(3), await __PRIVATE_enableNetworkInternal(n);
}
/**
* Toggles the network state when the client gains or loses its primary lease.
*/ async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
	const n = __PRIVATE_debugCast(e);
	t ? (n.Ea.delete(2), await __PRIVATE_enableNetworkInternal(n)) : t || (n.Ea.add(2), await __PRIVATE_disableNetworkInternal(n), n.Va.set("Unknown"));
}
/**
...
*/ function __PRIVATE_ensureWriteStream(e) {
	return e.fa || (e.fa = function __PRIVATE_newPersistentWriteStream(e, t, n) {
		...
		t ? (e.fa.B_(), await __PRIVATE_fillWritePipeline(e)) : (await e.fa.stop(), e.Ta.length > 0 && (__PRIVATE_logDebug(Ht$1, `Stopping write stream with ${e.Ta.length} pending writes`), e.Ta = []));
	}))), e.fa;
}
/**
* @license
...
async function __PRIVATE_eventManagerListen(e, t) {
	...
	s ? !s.Sa() && t.Da() && (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.Da() ? 0 : 1);
	try {
		switch (r) {
			case 0:
	...
	if (n.queries.set(i, s), s.ba.push(t), t.va(n.onlineState), s.wa) t.Fa(s.wa) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
async function __PRIVATE_eventManagerUnlisten(e, t) {
	...
	if (s) {
		...
		e >= 0 && (s.ba.splice(e, 1), 0 === s.ba.length ? i = t.Da() ? 0 : 1 : !s.Sa() && t.Da() && (i = 2));
	}
	switch (i) {
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
	...
	for (const e of t) {
		...
		if (i) {
			for (const t of i.ba) t.Fa(e) && (r = !0);
			i.wa = e;
		}
	}
...
(Zt = Jt || (Jt = {})).Ma = "default", Zt.Cache = "cache";
/**
...
*/ var __PRIVATE_BundleConverterImpl = class {
	...
	*/ qs(e) {
		return e.metadata.exists ? __PRIVATE_fromDocument(this.serializer, e.document, !1) : MutableDocument.newNoDocument(this.Ks(e.metadata.name), this.Us(e.metadata.readTime));
	}
	Us(e) {
...
*/ var __PRIVATE_BundleLoader = class {
	...
	*/ Ga(e) {
		...
		if (e.qa.namedQuery) this.Wa.push(e.qa.namedQuery);
			...
			this.Qa.push({ metadata: e.qa.documentMetadata }), e.qa.documentMetadata.exists || ++t;
...
*/ var __PRIVATE_SyncEngineImpl = class {
	constructor(e, t, n, r, i, s) {
		this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Pu = {}, this.Tu = new ObjectMap(((e) => __PRIVATE_canonifyQuery(e)), __PRIVATE_queryEquals), this.Iu = /* @__PURE__ */ new Map(), this.Eu = /* @__PURE__ */ new Set(), this.Ru = new SortedMap(DocumentKey.comparator), this.Au = /* @__PURE__ */ new Map(), this.Vu = new __PRIVATE_ReferenceSet(), this.du = {}, this.mu = /* @__PURE__ */ new Map(), this.fu = __PRIVATE_TargetIdGenerator.ar(), this.onlineState = "Unknown", this.gu = void 0;
	}
	get isPrimaryClient() {
		return !0 === this.gu;
	}
...
*/ async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
	e.pu = (t, n, r) => async function __PRIVATE_applyDocChanges(e, t, n, r) {
		let i = t.view.ru(n);
		i.Ss && (i = await __PRIVATE_localStoreExecuteQuery(e.localStore, t.query, !1).then((({ documents: e }) => t.view.ru(e, i))));
	...
	if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
		...
		r.Tu.forEach(((n, r) => {
			...
			n.queries.forEach(((e, n) => {
				for (const e of n.ba) e.va(t) && (r = !0);
			})), r && __PRIVATE_raiseSnapshotsInSyncEvent(n);
		}(r.eventManager, t), e.length && r.Pu.J_(e), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
	}
}
/**
...
*/ async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
	const n = __PRIVATE_debugCast(e);
	__PRIVATE_canUseNetwork(n.remoteStore) || __PRIVATE_logDebug(Xt$1, "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
	try {
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
	...
	if (e.Iu.delete(t), e.isPrimaryClient) e.Vu.Gr(t).forEach(((t) => {
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
	for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.Vu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
		...
		__PRIVATE_logDebug(Xt$1, "Document no longer in limbo: " + r.key), e.Vu.removeReference(r.key, t);
...
function __PRIVATE_trackLimboChange(e, t) {
	...
	e.Ru.get(n) || e.Eu.has(r) || (__PRIVATE_logDebug(Xt$1, "New document in limbo: " + n), e.Eu.add(r), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
/**
...
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
	...
	})), await Promise.all(o), r.Pu.J_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e, t) {
		const n = __PRIVATE_debugCast(e);
		try {
			await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", ((e) => PersistencePromise.forEach(t, ((t) => PersistencePromise.forEach(t.Ts, ((r) => n.persistence.referenceDelegate.addReference(e, t.targetId, r))).next((() => PersistencePromise.forEach(t.Is, ((r) => n.persistence.referenceDelegate.removeReference(e, t.targetId, r)))))))));
		} catch (e) {
			if (!__PRIVATE_isIndexedDbTransactionError(e)) throw e;
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
	...
	if (!n.currentUser.isEqual(t)) {
		__PRIVATE_logDebug(Xt$1, "User change. New user:", t.toKey());
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
	...
	}(i.localStore, t)) : fail(6720, "Unknown batchState", { bu: n }), await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(i, s)) : __PRIVATE_logDebug(Xt$1, "Cannot apply mutation batch with id: " + t);
}
...
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, r) {
	const i = __PRIVATE_debugCast(e);
	if (i.gu) return void __PRIVATE_logDebug(Xt$1, "Ignoring unexpected query state notification.");
	const s = i.Iu.get(t);
	...
	if (r.gu) {
		for (const e of t) {
			if (r.Iu.has(e) && r.sharedClientState.isActiveQueryTarget(e)) {
				__PRIVATE_logDebug(Xt$1, "Adding an already active target " + e);
				continue;
			}
		...
		for (const e of n) r.Iu.has(e) && await __PRIVATE_localStoreReleaseTarget(r.localStore, e, !1).then((() => {
...
*/ function __PRIVATE_syncEngineLoadBundle(e, t, n) {
	...
	(async function __PRIVATE_loadBundleImpl(e, t, n) {
		try {
			...
			return await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, o.Ja, void 0), await function __PRIVATE_localStoreSaveBundle(e, t) {
				const n = __PRIVATE_debugCast(e);
			...
			return __PRIVATE_logWarn(Xt$1, `Loading bundle failed with ${e}`), n._failWith(e), Promise.resolve(/* @__PURE__ */ new Set());
		}
	})(r, t, n).then(((e) => {
...
*/ var OnlineComponentProvider = class {
	...
	async terminate() {
		await async function __PRIVATE_remoteStoreShutdown(e) {
			const t = __PRIVATE_debugCast(e);
			__PRIVATE_logDebug(Ht$1, "RemoteStore shutting down."), t.Ea.add(5), await __PRIVATE_disableNetworkInternal(t), t.Aa.shutdown(), t.Va.set("Unknown");
...
*/ var __PRIVATE_BundleReaderImpl = class {
	constructor(e, t) {
		this.Bu = e, this.serializer = t, this.metadata = new __PRIVATE_Deferred(), this.buffer = new Uint8Array(), this.Lu = function __PRIVATE_newTextDecoder() {
			...
			e && e.Ua() ? this.metadata.resolve(e.qa.metadata) : this.metadata.reject(/* @__PURE__ */ new Error(`The first element of the bundle is not a metadata, it is\n             ${JSON.stringify(e?.qa)}`));
	...
	*/ async Uu(e) {
		for (; this.buffer.length < e;) await this.Wu() && this.qu("Reached the end of bundle when more is expected.");
...
var FirestoreClient = class {
	constructor(e, t, n, r, i) {
		this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this._databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (async (e) => {
			__PRIVATE_logDebug(Yt$1, "Received user=", e.uid), await this.authCredentialListener(e), this.user = e;
		})), this.appCheckCredentials.start(n, ((e) => (__PRIVATE_logDebug(Yt$1, "Received new app check token=", e), this.appCheckCredentialListener(e, this.user))));
	}
	get configuration() {
		return {
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
	...
	__PRIVATE_logDebug(Yt$1, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), e.setCredentialChangeListener(((e) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, e))), e.setAppCheckTokenChangeListener(((e, n) => __PRIVATE_remoteStoreHandleCredentialChange(t.remoteStore, n))), e._onlineComponents = t;
}
/**
...
/** Enables the network connection and re-enqueues all pending operations. */ function __PRIVATE_firestoreClientEnableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!0), function __PRIVATE_remoteStoreEnableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			return t.Ea.delete(0), __PRIVATE_enableNetworkInternal(t);
		}(n);
	}));
}
/** Disables the network connection. Pending operations will not complete. */ function __PRIVATE_firestoreClientDisableNetwork(e) {
	return e.asyncQueue.enqueue((async () => {
		...
		return t.setNetworkEnabled(!1), async function __PRIVATE_remoteStoreDisableNetwork(e) {
			const t = __PRIVATE_debugCast(e);
			t.Ea.add(0), await __PRIVATE_disableNetworkInternal(t), t.Va.set("Offline");
		}(n);
	}));
}
/**
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/ var en = "ComponentProvider", tn = /* @__PURE__ */ new Map();
/**
...
* limitations under the License.
*/
var nn = "firestore.googleapis.com", rn = !0;
/**
	...
	_setSettings(e) {
		...
		this._settings = new FirestoreSettingsImpl(e), this._emulatorOptions = e.emulatorOptions || {}, void 0 !== e.credentials && (this._authCredentials = function __PRIVATE_makeAuthCredentialsProvider(e) {
			...
			switch (e.type) {
				...
				default: throw new FirestoreError(C.INVALID_ARGUMENT, "makeAuthCredentialsProvider failed due to invalid credential type");
			}
		}(e.credentials));
	}
	_getSettings() {
...
*/ function connectFirestoreEmulator(e, t, n, r = {}) {
	...
	i && (pingServer(`https://${_}`), updateEmulatorBanner("Firestore", !0)), s.host !== nn && s.host !== _ && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
	const a = {
		...s,
		host: _,
		ssl: i,
	...
	if (!deepEqual(a, o) && (e._setSettings(a), r.mockUserToken)) {
		...
		if ("string" == typeof r.mockUserToken) t = r.mockUserToken, n = User.MOCK_USER;
			...
			if (!i) throw new FirestoreError(C.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
			n = new User(i);
		}
...
var __PRIVATE_AsyncQueueImpl = class {
	constructor(e = Promise.resolve()) {
		this.Yu = [], this.ec = !1, this.tc = [], this.nc = null, this.rc = !1, this.sc = !1, this.oc = [], this.M_ = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry"), this._c = () => {
			const e = getDocument();
			e && __PRIVATE_logDebug(sn, "Visibility state changed to " + e.visibilityState), this.M_.w_();
		}, this.ac = e;
		const t = getDocument();
...
function getFirestore(e, n) {
	const r = "object" == typeof e ? e : getApp(), i = "string" == typeof e ? e : n || st, s = _getProvider(r, "firestore").getImmediate({ identifier: i });
	if (!s._initialized) {
...
/** A "context" object passed around while parsing user data. */ var ParseContextImpl = class ParseContextImpl {
	...
	*/
	...
	createError(e) {
		return createError(e, this.settings.methodName, this.settings.hasConverter || !1, this.path, this.settings.targetDoc);
	}
...
*/ var UserDataReader = class {
	...
	/** Creates a new top-level parse context. */ createContext(e, t, n, r = !1) {
		return new ParseContextImpl({
			dataSource: e,
			methodName: t,
			targetDoc: n,
...
var __PRIVATE_ArrayUnionFieldValueImpl = class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayUnionTransformOperation(this.Ac.map(((e) => __PRIVATE_parseData(e, t))));
...
var __PRIVATE_ArrayRemoveFieldValueImpl = class __PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
	...
	_toFieldTransform(e) {
		const t = __PRIVATE_createSentinelChildContext(this, e, !0), r = new __PRIVATE_ArrayRemoveTransformOperation(this.Ac.map(((e) => __PRIVATE_parseData(e, t))));
		return new FieldTransform(e.path, r);
	}
	isEqual(e) {
	...
	*/
	...
	if (t.path && t.fieldMask.push(t.path), e instanceof Array) {
		...
		return function __PRIVATE_parseArray(e, t) {
			...
			let r = 0;
			for (const i of e) {
				let e = __PRIVATE_parseData(i, t.childContextForArray(r));
...
function __PRIVATE_parseObject(e, t) {
	...
	return isEmpty(e) ? t.path && t.path.length > 0 && t.fieldMask.push(t.path) : forEach(e, ((e, r) => {
		const i = __PRIVATE_parseData(r, t.childContextForField(e));
		null != i && (n[e] = i);
	})), { mapValue: { fields: n } };
}
...
*/ function __PRIVATE_fieldPathFromArgument(e, t, n) {
	...
	throw createError("Field path arguments must be of type string or ", e, !1, void 0, n);
}
/**
* Matches any characters in a field path string that are reserved.
*/ var an = /* @__PURE__ */ new RegExp("[~\\*/\\[\\]]");
/**
...
*/ function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
	if (t.search(an) >= 0) throw createError(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`, e, !1, void 0, n);
	try {
		return new FieldPath(...t.split("."))._internalPath;
	} catch (r) {
		throw createError(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`, e, !1, void 0, n);
	}
}
...
*/ var AbstractUserDataWriter = class {
	...
	*/ convertVectorValue(e) {
		const t = e.fields?.[ct].arrayValue?.values?.map(((e) => __PRIVATE_normalizeNumber(e.doubleValue)));
...
var Ut = "@firebase/firestore", Ht = "4.12.0";
/**
* @license
* Copyright 2017 Google LLC
*
...
*/ function __PRIVATE_validateNewFieldFilter(t, e) {
	...
	if (null !== n) throw n === e.op ? new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. You cannot use more than one '${e.op.toString()}' filter.`) : new FirestoreError(C.INVALID_ARGUMENT, `Invalid query. You cannot use '${e.op.toString()}' filters with '${n.toString()}' filters.`);
}
...
function documentSnapshotFromJSON(t, e, n) {
	if (__PRIVATE_validateJSON(e, DocumentSnapshot._jsonSchema)) {
		...
		return new DocumentSnapshot(t, new __PRIVATE_LiteUserDataWriter(t), c, u, new SnapshotMetadata(!1, !1), n || null);
	}
}
/**
* A `QueryDocumentSnapshot` contains data read from a document in your
...
function querySnapshotFromJSON(t, e, n) {
	if (__PRIVATE_validateJSON(e, QuerySnapshot._jsonSchema)) {
		...
		const l = ViewSnapshot.fromInitialDocuments(i, c, __PRIVATE_documentKeySet(), !1, !1), h = new Query(t, n || null, i);
...
function onSnapshot(t, ...e) {
	...
	return __PRIVATE_firestoreClientListen(ensureFirestoreConfigured(i), u, s, o);
}
